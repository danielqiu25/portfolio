export const aboutParagraphs = [
  ...
  "Software came easy to me, which I think is mostly a reason to go find problems that don't. That's what pulled me toward AI. The interesting parts are still unsolved, and there's a wide gap between a model that works in a notebook and a feature someone will actually use.",
] as const;
